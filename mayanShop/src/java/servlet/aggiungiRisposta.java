 ...
 * @author Michela
 */
@WebServlet(name = "aggiungiRisposta", urlPatterns = {"/aggiungiRisposta"})
public class aggiungiRisposta extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        recensioneBean recensione = new recensioneBean(testo, id ,utente.getIdUser());
        if(dbLayer.recensioneDAO.insertRisposta(recensione)){
