...
<html>
    <head>
        ...
        <link href="Styles/header.css" media='only screen and (min-width: 680px)' rel="stylesheet" type="text/css"/>
        <link href="Stylesmobile/header.css" media='only screen and (max-width: 680px)' rel="stylesheet" type="text/css" />
        <link href="Styles/visOggetto.css" media='only screen and (min-width: 1160px)' rel="stylesheet" type="text/css"/>
        <link href="Stylesmobile/visOggetto.css" media='only screen and (max-width: 680px)' rel="stylesheet" type="text/css"/>
        <link href="Stylesmobile/visOggetto_1.css" media='only screen and (max-width: 1160px) and (min-width: 680px)' rel="stylesheet" type="text/css"/>
