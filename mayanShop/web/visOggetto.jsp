...
<html>
    <head>
        ...
        <link href="Styles/visOggetto.css" media='only screen and (min-width: 1700px)' rel="stylesheet" type="text/css"/>
        <link href="Stylesmobile/visOggetto.css" media='only screen and (max-width: 1700px)' rel="stylesheet" type="text/css"/>
