...
<html>
    <head>
        ...
        <link href="Styles/notifiche.css" media='only screen and (min-width: 480px)' rel="stylesheet" type="text/css"/>
        <link href="Stylesmobile/notifiche.css" media='only screen and (max-width: 480px)' rel="stylesheet" type="text/css"/>
        ...
        <div id="bgFader">
            <div id="containerPopup">
                <div id="contenutoPopup">
                    ...
                    <div id="formRisposta">
                        <form action="./risSegnalazione" onsubmit="return valida();" method="post">
